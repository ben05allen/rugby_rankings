...
table = {
    Country.SOUTH_AFRICA: 92.79,
    Country.NEW_ZEALAND: 91.56,
    Country.IRELAND: 90.57,
    Country.FRANCE: 87.81,
    Country.ENGLAND: 83.72,
    Country.SCOTLAND: 83.43,
    Country.ARGENTIA: 82.42,
    Country.WALES: 80.65,
...
results = [
    # ((Country.ARGENTIA, 0, Ground.AWAY), (Country.ENGLAND, 0, Ground.AWAY)),
